...
1. Select the year and the twelve month variables from the `weather` dataset. We do not need the others (J-D, D-N, DJF, etc.) for this assignment. Hint: use `select()` function.DONE
...
gss <- gss %>% 
           mutate(snap_insta = case_when(instagrm == 'No' &  snapchat == 'Yes' ~ 'Yes', instagrm == 'Yes' &  snapchat == 'No' ~ 'Yes', instagrm == 'Yes' &  snapchat == 'Yes' ~ 'Yes', instagrm == 'No' &  snapchat == 'No' ~ 'No'))
...
snap_insta_prop <- gss %>% 
  ...
  summarise(proportion=count(snap_insta=="Yes")/count(snap_insta))
...
- Who did you collaborate with: All Group 26
